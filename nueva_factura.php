...
<head>
    ...
    <title>Nueva Factura - Sistema de Ventas</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.12.0/dist/sweetalert2.min.css">
    <style>
        body {
            background-color: #98FF98; /* Menta Suave */
        }
    </style>
</head>
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="nueva_factura.php">Nueva Factura</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <form id="form_nueva_factura" method="POST" action="../controllers/FacturaController.php?op=guardar_factura">
            <div class="card shadow-sm mb-4">
                <div class="card-header">Datos del Cliente (Opcional por ahora)</div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="cliente_nombre" class="form-label">Nombre del Cliente</label>
                        <input type="text" class="form-control" id="cliente_nombre" name="cliente_nombre" placeholder="Nombre o Razón Social del Cliente">
                    </div>
                    </div>
            </div>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">Detalle de Artículos en Factura</div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th colspan="2">S/ <span id="total_factura_display">0.00</span></th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                    <input type="hidden" name="articulos" id="articulos_json"> </div>
            </div>

            <div class="text-end mb-4">
                <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-save"></i> Generar Factura</button>
                <a href="facturas.php" class="btn btn-secondary btn-lg">Cancelar</a>
            </div>
        </form>
    </div>
    ...
    <script src="../assets/js/nueva_factura.js"></script>
</body>
</html>